...
Shader "Shadero Customs/GoldShader"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_Generate_Shape_PosX_1("_Generate_Shape_PosX_1", Range(-1, 2)) = 0.5
_Generate_Shape_PosY_1("_Generate_Shape_PosY_1", Range(-1, 2)) = 0.577
_Generate_Shape_Size_1("_Generate_Shape_Size_1", Range(-1, 1)) = 0.276
