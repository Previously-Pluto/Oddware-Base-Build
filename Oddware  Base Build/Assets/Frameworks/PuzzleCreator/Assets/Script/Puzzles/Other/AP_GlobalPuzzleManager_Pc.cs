...
= new List<EditorMethodsList_Pc.MethodsList>();
    ...
    public GameEvent m_puzzleCompletedEvent;
    public StringEvent m_puzzleGlobalVar;
    public Transform m_currentPuzzle;
   ...
   public Camera returnMainCamera()
    ...
    public void ActivateNovel()
    {
        m_puzzleCompletedEvent.Raise();
    }
}
