    ...
    public class TransformToolsWindow : BaseToolWindow
    {
...
#else
                _progressionGroupOpen = EditorGUILayout.Foldout(_progressionGroupOpen, "Increment");
#endif
        ...
        private void OnGuiAlignGroup()
        {
            using (new GUILayout.VerticalScope(_skin.box))
            {
                ...
                _alignObjectProperty = (TransformTools.ObjectProperty)EditorGUILayout.Popup((int)_alignObjectProperty, _alingObjPropOptions, GUILayout.Width(128));
                ...
                using (new GUILayout.HorizontalScope())
                {
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignRightToAnchorLeft"), "Align right edges of objects to the left edge of the anchor"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignLeft"), "Align left edges"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignCenterX"), "Center on X axis"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignRight"), "Align right edges"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignLeftToAnchorRight"), "Align left edges of objects to the right edge of the anchor"), _buttonStyle))
                    {
                ...
                using (new GUILayout.HorizontalScope())
                {
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignTopToAnchorBottom"), "Align top edges of objects to the bottom edge of the anchor"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignBottom"), "Align bottom edges"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignCenterY"), "Center on Y axis"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignTop"), "Align top edges"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignBottomToAnchorTop"), "Align bottom edges of objects to the top edge of the anchor"), _buttonStyle))
                    {
                ...
                using (new GUILayout.HorizontalScope())
                {
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignFrontToAnchorBack"), "Align front edges of objects to the back edge of the anchor"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignBack"), "Align back edges"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignCenterZ"), "Center on Z axis"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignFront"), "Align front edges"), _buttonStyle))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/AlignBackToAnchorFront"), "Align back edges of objects to the front edge of the anchor"), _buttonStyle))
                    {
        ...
        private void OnGuiProgressionGroup()
        {
            GUILayout.BeginVertical(_skin.box);
            {
                GUILayout.BeginHorizontal();
                {
                    ...
                    {
                        var progressivePositionWindow = (PositionProgressionWindow)GetWindow<PositionProgressionWindow>();
                    ...
                    {
                        var progressiveRotationWindow = (RotationProgressionWindow)GetWindow<RotationProgressionWindow>();
                    ...
                    {
                        var progressiveScaleWindow = (ScaleProgressionWindow)GetWindow<ScaleProgressionWindow>();
        ...
        private void OnGuiEditPivotGroup()
        {
            GUILayout.BeginVertical(_skin.box);
            {
                GUILayout.BeginHorizontal();
                {
                    ...
                    if (_pivot != null)
                    {
                        if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/Apply"), "Apply"), _buttonStyle))
                        {
                        ...
                        if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/Cancel"), "Cancel"), _buttonStyle))
                        {
                            CancelEditPivot(true);
                        }
                    }
        ...
        private void OnGuiPlaceOnSurfaceGroup()
        {
            GUILayout.BeginVertical(_skin.box);
            {
                GUILayout.BeginHorizontal();
                {
                    ...
                    {
                        var placeOnSurfaceWindow = (SimulatePhysicsWindow)GetWindow<SimulatePhysicsWindow>();
                        placeOnSurfaceWindow.Show();
                    }
                    if (GUILayout.Button(new GUIContent(Resources.Load<Texture2D>("Sprites/SimulateGravity"), "Simulate Gravity"), _buttonStyle))
                    {
                        var simPhysWindow = (SimulatePhysicsWindow)GetWindow<SimulatePhysicsWindow>();
                        simPhysWindow.Show();
                    }
