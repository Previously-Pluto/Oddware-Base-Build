...
public class actionsWhenPuzzleIsSolved_Pc : MonoBehaviour {
    ...
    public UnityEvent m_onPuzzleCompleted;
    private void Start()
	{
        #region
    ...
    {
        SetGlobalVariableValue();   //set the global variable value
        #region
    ...
    public void SetGlobalVariableValue()
    {
        ...
        {
            AP_GlobalPuzzleManager_Pc.instance.m_puzzleGlobalVar.testProperty = globalVariable;
            AP_GlobalPuzzleManager_Pc.instance.m_puzzleGlobalVar.Raise(globalVariable);
        }
    }
}
