...
{
    public class ParticlesFX_Welcome : EditorWindow
    {
        //sUBSCRIBE
        ...
        [MenuItem("Tools/OrangedKeys/ParticlesFXShader/About ", false, 0)]
        public static void ShowWindow()
        {
            EditorWindow editorWindow = GetWindow(typeof(ParticlesFX_Welcome), false, " About ", true);
        ...
        private void OnGUI()
        {
            ...
            */
            ...
            EditorGUILayout.LabelField("Have fun with ''ParticlesFX Shader'' !! \n", LargeTextStyle);
            EditorGUILayout.Space();
