...
namespace Naninovel.UI
{
    ...
    public class TipsPanel : CustomUI, ITipsUI
    {
        ...
        public virtual int TipsCount { get; set; }
        ...
        public string SeparatorLiteral => separatorLiteral;
        ...
        public IUnlockableManager UnlockableManager => unlockableManager;
        public IInputManager InputManager => inputManager;
        public ITextManager TextManager => textManager;
        public List<TipsListItem> ListItemsProperty => listItems;
